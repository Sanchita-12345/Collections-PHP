<?php
    ...
    class SearchBinaryTree {
        ...
        echo "<br>Input vector is : ", join($arr," "), "<br>";

        echo"<br>Breadth-First Traversal Tree"; 
        echo $tree->BFT();

        echo"<br><br>Inorder Traversal is : <br>"; 
        $tree->traverse('inorder');

        echo"<br><br>Postorder Traversal is : <br>"; 
        $tree->traverse('postorder');

        echo"<br><br>Preorder Traversal is : <br>"; 
